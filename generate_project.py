...
/* Begin PBXGroup section */
		...
		000000020002000200000003 /* Tunnexa App */ = {
			isa = PBXGroup;
			children = (
				1100000200020002000F /* App */,
				1100000200020002001F /* Views */,
				1100000200020002002F /* ViewModels */,
		...
		1100000200020002000F /* App */ = {
			isa = PBXGroup;
			children = (
				1100000200020002000E /* TunnexaApp.swift */,
			);
			name = App;
			path = App;
			sourceTree = "<group>";
		...
		1100000200020002001F /* Views */ = {
			isa = PBXGroup;
			children = (
				1100000200020002000A /* MainView.swift */,
				1100000200020002000B /* ProxiesView.swift */,
				1100000200020002000C /* DiagnosticsView.swift */,
				1100000200020002000D /* SettingsView.swift */,
			);
			name = Views;
			path = Views;
			sourceTree = "<group>";
		...
		1100000200020002002F /* ViewModels */ = {
			isa = PBXGroup;
			children = (
				11000002000200020008 /* ProxyViewModel.swift */,
				11000002000200020009 /* VPNViewModel.swift */,
			);
			name = ViewModels;
			path = ViewModels;
			sourceTree = "<group>";
		...
		1100000200020002003F /* Persistence */ = {
			isa = PBXGroup;
			children = (
				11000002000200020004 /* KeychainHelper.swift */,
			);
			name = Persistence;
			path = Persistence;
			sourceTree = "<group>";
		...
		1100000200020002004F /* YAML */ = {
			isa = PBXGroup;
			children = (
				11000002000200020003 /* YAMLParser.swift */,
			);
			name = YAML;
			path = YAML;
			sourceTree = "<group>";
		...
		000000020002000200000004 /* TunnexaPacketTunnel Extension */ = {
			isa = PBXGroup;
			children = (
				11000002000200020006 /* PacketTunnelProvider.swift */,
				11000002000200020005 /* LocalProxyServer.swift */,
				11000002000200020010 /* TunnexaPacketTunnel.entitlements */,
				11000002000200020012 /* Info.plist */,
			);
		...
		000000020002000200000005 /* TunnexaTests */ = {
			isa = PBXGroup;
			children = (
				44000002000200020001 /* YAMLParserTests.swift */,
				44000002000200020002 /* RoutingTests.swift */,
			);
			name = TunnexaTests;
			path = TunnexaTests;
			sourceTree = "<group>";
		...
		000000020002000200000006 /* Products */ = {
			isa = PBXGroup;
			children = (
				22000002000200020002 /* Tunnexa.app */,
				22000002000200020001 /* TunnexaPacketTunnel.appex */,
				44000002000200020003 /* TunnexaTests.xctest */,
			);
			name = Products;
			sourceTree = "<group>";
		};
